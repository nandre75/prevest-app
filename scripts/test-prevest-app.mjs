...
assert(irisRingCss.includes('margin-block: -8px'), 'CTA. débordement vertical avatar uniquement')
...
assert(hero.includes('max-width: none'), 'CTA. desktop sans plafond artificiel')
